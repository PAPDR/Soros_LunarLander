...
class FixedFeatureMap:
    ...
    def get_size(self):
        return self.num_individuals_added
...
def runME(runnum, game, sequence_len, 
    ...
    #Go through the number of individuals and determine their feasiblility
